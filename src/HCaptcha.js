...
module.exports = class HCaptchaSolver{
    ...
    constructor({apiKey,userAgent,siteKey,siteURL,enableLogger,loggerFunction,delay=7000}){
        this.key = apiKey
        this.userAgent = userAgent
        this.siteurl = siteURL
        this.sitekey = siteKey
        this.initialized = false
        this.httpHeaders = { apikey:apiKey }
        this.hsw = null
        this.isLoggingEnabled = enableLogger || false,
        this.logFunction = loggerFunction
        this.delay = delay
